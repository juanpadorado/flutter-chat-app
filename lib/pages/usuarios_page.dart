...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  final usuarios = [
    Usuario(uid: '1', nombre: 'Juan', email: 'test@test.com', online: true),
    Usuario(uid: '2', nombre: 'Fercho', email: 'test1@test.com', online: true),
    Usuario(uid: '3', nombre: 'Maria', email: 'test2@test.com', online: false),
  ];
